...
<body>
        ...
        <form style="margin-left:200px;">
            ...
            <div class="" style="margin-left:  ; margin-top: 15px;">
            ...
            <div class="" style="margin-left: ;"><label style="display: inline-block;">8.When Required
                    :</label>
                <div class="radio" style="display: inline-block;">
                    <label>
            ...
            <div class="" style="margin-left:;">
                ...
                <div>
                    ...
                    <div class="checkbox" style=" display: inline-block; margin-left: 22px">
                        <label>
            ...
            <div class="" style="margin-left:; margin-top:15px;">
                ...
                <br>
                <textarea style=" height:; width:775px;">
...
•	Good Presentation skill.
            ...
            <div class="" style="border:1px solid black; margin-left:; width:660px;"></div>
            ...
            <div class="" style="margin-top:10px; margin-left:;width:775px;">
                <label>11.2: Schedules:</label>
                <div>
                    <table class="table table-bordered">
                        <thead>
                            <tr style="">
                                <th style="text-align:center;width:400px;">Task</th>
